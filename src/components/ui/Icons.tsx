export function LogoMark({
  ...
  return (
    <svg
      ...
      aria-hidden="true"
    >
      <circle cx="24" cy="32" r="16" stroke="#472439" strokeWidth={stroke} />
      <circle cx="40" cy="32" r="16" stroke="#E08A7E" strokeWidth={stroke} />
    </svg>
  );
}

export function LogoWord({ size = 18 }: { size?: number }) {
  return (
    <span
      style={{
        display: "inline-flex",
        ...
        color: "var(--tm-plum-700)",
      }}
    >
      <LogoMark size={Math.round(size * 1.4)} stroke={2.4} />
      <span>Findwell</span>
    </span>
  );
}
