...
export const patientSurvey: SurveyDefinition = {
  id: "patient",
  ...
  questions: [
    ...
    // Section 2: For People Who Have Tried Therapy
    {
      ...
      shortLabel: "Last search (recency)",
      options: [
    ...
    },
    {
      ...
      shortLabel: "Where started looking",
      required: false,
      nextQuestionId: "p4",
    },
    {
    ...
    },
    {
      ...
      shortLabel: "# met before good fit",
      options: [
    ...
    },
    {
      ...
      shortLabel: "Considered giving up?",
      options: [
        { label: "Yes", value: "yes" },
        { label: "No", value: "no" },
    ...
    },
    {
      ...
      shortLabel: "What would've helped",
      required: false,
      nextQuestionId: null,
    },
    ...
    },
    {
      ...
      shortLabel: "What enables first step",
      required: false,
      nextQuestionId: null,
    },
